 ...
 */
final class Version20210903195937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auxiliar ADD remesa_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX fk_auxiliar_remesa_idx ON auxiliar (remesa_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_auxiliar_remesa_idx ON auxiliar');
        $this->addSql('ALTER TABLE auxiliar DROP remesa_id');
