 ...
 */
final class Version20210902160812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auxiliar ADD criterio_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_407BE8B279D49D26 ON auxiliar (criterio_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auxiliar DROP FOREIGN KEY FK_407BE8B279D49D26');
        $this->addSql('DROP INDEX IDX_407BE8B279D49D26 ON auxiliar');
        $this->addSql('ALTER TABLE auxiliar DROP criterio_id');
